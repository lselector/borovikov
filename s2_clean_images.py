...
Standard output: 800x600 JPEG, 72 DPI, 16 px minimum
margin, white background. That size is chosen so the images
render at a sensible size in a Markdown viewer, which cannot
resize them, while keeping the stamped characters on the
engine data plate legible.
...
Usage:
    ...
    python3 s2_clean_images.py images/engine-plate-wide.jpg
